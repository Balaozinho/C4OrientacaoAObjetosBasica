...
class TestaAlgunsMetodos {
	public static void main (String [] args){
		...
		//criando conta
		Conta minhaConta;//Além disso, o objeto criado deverá ser acessado, por isso iremos criar uma variável para referencia
		...
		//saca 200 reais
		minhaConta.saca(200); //Para mandar msg ao objeto e pedir a execução do método, também é utilizado o ponto (invocação do metódo)
